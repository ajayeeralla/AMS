        ...
        { 
            ...
            {  
                ...
                else
                {
                  ...
                  string query1="select * from userattendance where userid='"+Login.sUid+"' and (attdate='"+DateTime .Now .ToString("yyyy-MM-dd")+"' and time between '"+tm9AM+"' and '"+tm12AM+"' or attdate ='"+DateTime.Now.ToString() +"'  and time between '" +tm2PM+"' and '"+tm5PM+"')";
                ...
                MySqlDataReader reader3 = cmdMySql1.ExecuteReader();
                 ...
                 if (reader3.HasRows )
                    ...
                    else if((tmNow>=tm2PM)&&(tmNow<=tm5PM))
                    {
                        ...
                        MessageBox.Show("you given attandance today", "Message", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
